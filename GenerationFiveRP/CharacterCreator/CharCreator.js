...
var featureNames = ["Largeur du nez", "Hauteur du nez", "Longueur de la pointe du nez", "Pronfondeur du nez", "Hauteur du bout du nez", "Déformation du nez", "Hauteur des sourcils", "Profondeur des sourcils", "Hauteur des pommettes", "Largeur des pommettes", "Profondeur des pommettes", "Taille des yeux", "Épaisseur des lèvres", "Largeur de la mâchoire", "Forme de la mâchoire", "Hauteur du menton", "Profondeur du menton", "Largeur du menton", "Fossette du menton", "Largeur du cou"];
var creatorFeaturesItems = [];

var appearanceNames = ["Imperfections", "Pilosité faciale", "Sourcils", "Vieillissement", "Maquillage", "Blush", "Teint de peau", "Dommages causés par le soleil", "Rouge à lèvres", "Taches de rousseur", "Pilosité du torse"];
var creatorAppearanceItems = [];
var creatorAppearanceOpacityItems = [];

var appearanceItemNames = [
    // blemishes
    ["Aucune", "Rougeole", "Boutons", "Petite acnée", "Break Out", "Points noir", "Build Up", "Pustules", "Zits", "Grosse acnée", "Acnée moyenne", "Irritation des joues", "Irritation du visage", "Picker", "Puberty", "Eyesore", "Chin Rash", "Two Face", "T Zone", "Greasy", "Marked", "Acne Scarring", "Full Acne Scarring", "Cold Sores", "Impetigo"],
    // facial hair
    ["Aucune", "Light Stubble", "Balbo", "Circle Beard", "Goatee", "Chin", "Chin Fuzz", "Pencil Chin Strap", "Scruffy", "Musketeer", "Mustache", "Trimmed Beard", "Stubble", "Thin Circle Beard", "Horseshoe", "Pencil and 'Chops", "Chin Strap Beard", "Balbo and Sideburns", "Mutton Chops", "Scruffy Beard", "Curly", "Curly & Deep Stranger", "Handlebar", "Faustic", "Otto & Patch", "Otto & Full Stranger", "Light Franz", "The Hampstead", "The Ambrose", "Lincoln Curtain"],
    // eyebrows
    ...
    // freckles
    ["Aucune", "Cherub", "All Over", "Irregular", "Dot Dash", "Over the Bridge", "Baby Doll", "Pixie", "Sun Kissed", "Beauty Marks", "Line Up", "Modelesque", "Occasional", "Speckled", "Rain Drops", "Double Dip", "One Sided", "Pairs", "Growth"],
    // chest hair
    ["Aucune", "Natural", "The Strip", "The Tree", "Hairy", "Grisly", "Ape", "Groomed Ape", "Bikini", "Lightning Bolt", "Reverse Lightning", "Love Heart", "Chestache", "Happy Face", "Skull", "Snail Trail", "Slug and Nips", "Hairy Arms"]
];
...
var eyeColors = ["Vert", "Bleu clair", "Bleu océan", "Marron clair", "Marron foncé", "Marron vert", "Gris foncé", "Gris clair"];
var hairItem = null;
...
function fillHairMenu() {
    ...
    for (var i = 0; i < eyeColors.length; i++) eye_list.Add(eyeColors[i]);
...
API.onEntityStreamIn.connect(function (ent, entType) {
    if (entType == 6 && (API.getEntityModel(ent) == 1885233650 || API.getEntityModel(ent) == -1667301416) && API.hasEntitySyncedData(ent, "CustomCharacter")) {
        ...
        for (var i = 0; i < data.Appearance.length; i++) {
            ...
            API.sendChatMessage("CharCreator 1 " + i.toString());
        }
