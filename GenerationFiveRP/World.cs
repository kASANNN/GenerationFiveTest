...
namespace GenerationFiveRP
{
    ...
    {
        private static Timer _worldSecTimer;
        ...
        public static void WorldFuncTimer()
        {
            _worldSecTimer = new Timer(60000.0);
            _worldSecTimer.Elapsed += new ElapsedEventHandler(SystemePaye.CuntdownPayday);
            _worldSecTimer.Enabled = true;
        }
